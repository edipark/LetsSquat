function [Femur, Tibia, Body, Foot, Mass, Type, Barbell]= Sim1() 
%%% GUI Part %%%
    ...
    result_str = { ...
        ...
        '---------------------------------'};
    hBox = msgbox(result_str, 'Simulation Report'); 
    uiwait(hBox); 
    

    [kneeInt, hipInt, trunkAng] = plotLocalTorqueHeatmapUI(config, Type, 185, theta_Tibia_f_deg);
